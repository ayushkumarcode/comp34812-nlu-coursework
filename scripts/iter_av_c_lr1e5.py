...
def main():
    ...
    print_metrics(metrics, "AV Cat C (LR=1e-5) — Final w/ Threshold")

    save_predictions(final_preds,
                     PROJECT_ROOT / 'predictions' / 'av_Group_34_C_lr1e5_v2.csv')
    for name, bl in {'SVM': 0.5610, 'LSTM': 0.6226, 'BERT': 0.7854}.items():
